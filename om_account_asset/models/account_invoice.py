...
class AccountInvoiceLine(models.Model):
    ...
    asset_mrr = fields.Float(string='Revenus mensuels récurrents', compute='_get_asset_date', readonly=True,
        ...
        for rec in self:
            ...
            if cat:
                if cat.method_number == 0 or cat.method_period == 0:
                    raise UserError(_("Le nombre d'amortissements ou la durée de la peripod"
